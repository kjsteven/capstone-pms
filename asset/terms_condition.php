...
<body class="bg-white mt-10 text-gray-800">

    <header class="text-black py-4 text-center">
        <h1 class="text-3xl font-semibold">Terms and Conditions</h1>
    </header>
    ...
    <section class="p-6">
        ...
        <p class="mb-4">Your privacy is important to us. Please review our <a href="privacy_policy.php" class="text-blue-600 hover:underline">Privacy Policy</a> to understand how we collect, use, and protect your data.</p>
    ...
    <footer class=" text-gray-500 py-4 text-center">
        <p>&copy; 2024 PropertyWise. All Rights Reserved.</p>
    </footer>
