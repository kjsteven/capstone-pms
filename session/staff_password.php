...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user) {
        ...
        $stmt = $conn->prepare("UPDATE staff SET ResetToken = ? WHERE Email = ?");
        ...
        try {
            ...
            header("Location: staff_password.php");
            exit();
        } catch (Exception $e) {
...
<section class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center p-6">
  <div class="w-full p-6 bg-white rounded-lg shadow dark:border sm:max-w-md dark:bg-gray-800 dark:border-gray-700 px-4 sm:px-6">
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400 mt-4">
          Already have an account? <a href="../authentication/stafflogin.php" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Login</a>
      </p>
  </div>
</section>
