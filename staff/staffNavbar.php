        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3 relative">
                    <!-- Notification Icon (Feather Icon) -->
                    <button type="button" class="flex items-center justify-center w-10 h-10 bg-blue-700 rounded-full text-white" id="notification-button">
                        ...
                        <i data-feather="bell" class="text-blue-800 dark:text-white"></i>
                    </button>
...
<script>
    ...
    feather.replace(); // Replaces all <i> elements with Feather Icons
